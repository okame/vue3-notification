import { defineComponent as y, openBlock as a, createBlock as g, TransitionGroup as w, withCtx as $, renderSlot as v, createElementBlock as p, normalizeStyle as E, resolveDynamicComponent as B, Fragment as H, renderList as M, normalizeClass as D, createElementVNode as C, createCommentVNode as R } from "vue";
function V(t) {
...
const d = V(), L = /* @__PURE__ */ new Map(), N = {
  x: ["left", "center", "right"],
  y: ["top", "bottom"]
...
const P = /* @__PURE__ */ T(z, [["render", F]]), q = y({
  name: "css-group",
  inheritAttrs: !1,
  props: {
...
const K = /* @__PURE__ */ T(q, [["render", J]]), h = "[-+]?[0-9]*.?[0-9]+", k = [
  {
    name: "px",
  ...
  methods: {
    ...
    addItem(t = {}) {
      ...
      const e = typeof t.duration == "number" ? t.duration : this.duration, i = typeof t.speed == "number" ? t.speed : this.speed, o = typeof t.ignoreDuplicates == "boolean" ? t.ignoreDuplicates : this.ignoreDuplicates, { title: s, text: c, type: n, data: l, id: x, color: I, backgroundColor: O } = t, r = {
        id: x || W(),
        title: s,
        text: c,
        type: n,
      ...
      let u = -1;
      const _ = this.active.some((A) => A.title === t.title && A.text === t.text);
      (!o || !_) && (S ? (this.list.push(r), this.$emit("start", r), this.active.length > this.max && (u = 0)) : (this.list.unshift(r), this.$emit("start", r), this.active.length > this.max && (u = this.active.length - 1)), u !== -1 && this.destroy(this.active[u]));
    },
    closeItem(t) {
      this.destroyById(t);
    },
    ...
    notifyWrapperStyle(t) {
      if (this.isVA)
        return;
      const e = { transition: `all ${t.speed}ms` };
      return t.color !== void 0 && (e.color = t.color), t.color !== void 0 && (e.backgroundColor = t.backgroundColor), e;
    },
    destroy(t) {
    ...
    (a(), g(B(t.componentName), {
      ...
      default: $(() => [
        (a(!0), p(H, null, M(t.active, (n) => (a(), p("div", {
          ...
          style: E(t.notifyWrapperStyle(n)),
          "data-id": n.id,
...
const st = /* @__PURE__ */ T(X, [["render", ot]]), b = (t) => {
...
const lt = () => ({ notify: b });
function nt(t, e = {}) {
  Object.entries(e).forEach((o) => L.set(...o));
  const i = e.name || "notify";
  t.config.globalProperties["$" + i] = b, t.component(e.componentName || "Notifications", st);
}
const ct = {
  install: nt
};
